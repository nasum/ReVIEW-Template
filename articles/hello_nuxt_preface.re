...
本書は@<ttb>{Vue.js}でユニバーサルなアプリケーションを構築するためのフレームワーク@<ttb>{Nuxt.js}の入門書です。@<ttb>{Vue.js}と@<ttb>{Vuex}、@<ttb>{vue-route}を触ったことのある人であれば問題なく読むことができるように作成されています。@<ttb>{Vue.js}は触ったこと歩けど@<ttb>{Nuxt.js}は触ったことない、@<ttb>{Nuxt.js}の使いどころがわからないという人が想定読者となっています。
